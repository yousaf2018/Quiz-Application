...
public class coursesAdapter extends RecyclerView.Adapter<coursesAdapter.ProgramViewHolder> {

    private List<Model_Class> itemList;
    private  View itemview;
    private Context context;

    public coursesAdapter(List<Model_Class>itemList){
    ...
    public class ProgramViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(int quiz_image1, String quiz_title1) {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("quizTitle",quiz_title1);
